public class Password {
    ...
    public String calculateScore(){
        ...
        if(Score == 6){
            return " this is a very good password :D check the useful inforsmtion seciton to make sure it satisfies the guidance";

        }else if(Score >=4){
            return "this is a good passord :D but you can do better";
        }else if(Score >=3){
